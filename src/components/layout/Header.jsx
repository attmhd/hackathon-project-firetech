      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <div className="flex items-center space-x-3 sm:space-x-4">
            ...
            <Link
              to="/kontributor"
              className="hidden lg:flex items-center gap-2 h-10 xl:h-12 px-4 xl:px-6 bg-gradient-to-r from-[#FF8D28] to-[#FF7A1A] text-white rounded-full font-bold text-sm xl:text-base hover:shadow-lg hover:scale-105 transition-all duration-300 shadow-md"
            >
              <PlusIcon />
      ...
      >
        <div className="mx-4 sm:mx-6 mt-4 bg-white/95 backdrop-blur-lg rounded-2xl shadow-xl border border-white/20 overflow-hidden">
          ...
          <div className="p-4 pt-0 border-t border-zinc-200/50">
            <Link
              to="/kontributor"
              className="flex items-center justify-center gap-2 w-full h-12 bg-gradient-to-r from-[#FF8D28] to-[#FF7A1A] text-white rounded-xl font-bold text-sm hover:shadow-lg transition-all duration-300 shadow-md"
              onClick={() => setIsMenuOpen(false)}
            >
              <PlusIcon />
              <span>Kontribusi</span>
